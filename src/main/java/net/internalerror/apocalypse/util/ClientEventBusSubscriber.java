package net.internalerror.apocalypse.util;

import net.internalerror.apocalypse.Apocalypse;
import net.internalerror.apocalypse.client.entity.render.EvolvedZombieRenderer;
...
public class ClientEventBusSubscriber {
    ...
    public static void onClientSetup(FMLClientSetupEvent event) {
        RenderingRegistry.registerEntityRenderingHandler(ModEntityType.EVOLVED_ZOMBIE.get(), EvolvedZombieRenderer::new);
    }
